...
image::/images/vscode-extension/payara-micro/create-new-project.png[Generate Payara Micro Application]

* Answer the prompts (groupId, artifactId, version, etc) to setup the project.

image::/images/vscode-extension/payara-micro/create-new-project-set-group-id.png[Enter GAV details]

* Select the Payara Micro version and the destination folder, where the project will be generated:

image::/images/vscode-extension/payara-micro/create-new-project-set-version.png[Select Payara Micro version]
...
image::/images/vscode-extension/payara-micro/add-to-current-workspace.png[Application created]
image::/images/vscode-extension/payara-micro/new-project-created.png[Application created]
...
image::/images/vscode-extension/payara-micro/new-project-start.png[Start Instance]

* After starting the Micro instance, you may see the log in the OUTPUT window:

image::/images/vscode-extension/payara-micro/new-project-running.png[Application running]
...
image::/images/vscode-extension/payara-micro/project-redeploy.png[Application redeploy]